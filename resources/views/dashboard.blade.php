...
<head>
    ...
    <link rel="shortcut icon" href="https://themes.openux.studio/quicky/favicon.ico" />
...
<body class="chats-tab-open">
    ...
    <div class="main-layout">
        ...
        <div class="navigation navbar navbar-light bg-primary">
            <!-- Logo Start -->
            <a class="d-none d-xl-block bg-light rounded p-1" href="https://themes.openux.studio/quicky/index.html">
            ...
            <ul class="nav nav-minimal flex-row flex-grow-1 justify-content-between flex-xl-column justify-content-xl-center" id="mainNavTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link p-0 py-xl-3 active" id="chats-tab" href="#chats-content" title="Chats">
                        ...
                        <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/outline/chat-alt-2.svg')}}" alt="Chat icon"> -->
                    </a>
                </li>
                <!-- Chats Tab End -->
                ...
                <li class="nav-item">
                    <a class="nav-link p-0 py-xl-3 " id="calls-tab" href="#calls-content" title="Calls">
                        ...
                        <!-- Alternate :: External File link -->
                        <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/outline/phone.svg')}}" alt="Phone icon"> -->
                    </a>
                </li>
                <!-- Calls Tab End -->
                ...
                <li class="nav-item">
                    <a class="nav-link p-0 py-xl-3" id="friends-tab" href="#friends-content" title="Friends">
                        ...
                        <!-- Alternate :: External File link -->
                        <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/outline/users.svg')}}" alt="Friends icon"> -->
                    </a>
                </li>
                <!-- Friends Tab End -->
                ...
                <li class="nav-item">
                    <a class="nav-link p-0 py-xl-3" id="profile-tab" href="#profile-content" title="Profile">
                        ...
                        <!-- Alternate :: External File link -->
                        <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/outline/user-circle.svg')}}" alt="Profile icon"> -->
                    </a>
                </li>
                <!-- Profile Tab End -->
            </ul>
                        ...
                        <div class="hide-scrollbar h-100" id="chatContactsList">
                                    ...
                                    <ul class="nav flex-nowrap">
                                        ...
                                        <li class="nav-item list-inline-item mr-1">
                                            <a class="nav-link text-muted px-1" href="#" title="Notifications" role="button" data-toggle="modal" data-target="#notificationModal">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-20" src="./{{asset('assets/media/heroicons/outline/bell.svg')}}" alt=""> -->
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item list-inline-item d-block d-xl-none mr-1">
                                            <a class="nav-link text-muted px-1" href="#" title="Appbar" data-toggle-appbar="">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="hw-20" src="./{{asset('assets/media/heroicons/outline/view-grid.svg')}}" alt="" class="injectable hw-20"> -->
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item list-inline-item mr-0">
                                            <div class="dropdown">
                                                <a class="nav-link text-muted px-1" href="#" role="button" title="Details" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img  class="injectable hw-20" src="./{{asset('assets/media/heroicons/outline/dots-vertical.svg')}}" alt=""> -->
                                                </a>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <div class="input-group-text transparent-bg border-left-0" role="button">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-20" src="./{{asset('assets/media/heroicons/outline/search.svg')}}" alt=""> -->
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <ul class="contacts-list" id="chatContactTab" data-chat-list="">
                                    ...
                                    <a class="contacts-link"  href="chat-2.html">
                                        <div class="avatar bg-success text-light">
                                            <span>
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable" src="./{{asset('assets/media/heroicons/outline/user-group.svg')}}" alt=""> -->
                                            </span>
                                        </div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <div class="d-inline-flex align-items-center ml-1">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-16 text-muted" src="./{{asset('assets/media/heroicons/solid/lock-closed.svg')}}" alt=""> -->
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <li class="contacts-item friends">
                                    <a class="contacts-link" href="#">
                                        <div class="avatar avatar-busy"><img src="{{asset('assets/media/avatar/3.png')}}" alt=""></div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-20 text-muted" src="./{{asset('assets/media/heroicons/solid/photograph.svg')}}" alt=""> -->
                                ...
                                <li class="contacts-item unread">
                                    <a class="contacts-link" href="#">
                                        <div class="avatar avatar-online">
                                            <img src="{{asset('assets/media/avatar/4.png')}}" alt="">
                                        </div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                ...
                                <li class="contacts-item friends">
                                    <a class="contacts-link" href="#">
                                        <div class="avatar avatar-offline">
                                            <img src="{{asset('assets/media/avatar/5.png')}}" alt="">
                                        </div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-20 text-muted" src="./{{asset('assets/media/heroicons/solid/document-report.svg')}}" alt=""> -->
                                ...
                                <li class="contacts-item friends">
                                    <a class="contacts-link" href="#">
                                        <div class="avatar avatar-online"><img src="{{asset('assets/media/avatar/6.png')}}" alt=""></div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <div class="d-inline-flex align-items-center ml-1">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-16 text-muted" src="./{{asset('assets/media/heroicons/solid/volume-off.svg')}}" alt=""> -->
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <li class="contacts-item friends">
                                    <a class="contacts-link" href="#">
                                        <div class="avatar avatar-offline"><img src="{{asset('assets/media/avatar/7.png')}}" alt=""></div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-16 text-muted" src="./{{asset('assets/media/heroicons/solid/phone-incoming.svg')}}" alt=""> -->
                                ...
                                <li class="contacts-item archived">
                                    <a class="contacts-link" href="#">
                                        <div class="avatar avatar-away"><img src="{{asset('assets/media/avatar/8.png')}}" alt=""></div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                    ...
                                    <ul class="nav flex-nowrap">
                                        ...
                                        <li class="nav-item list-inline-item mr-1">
                                            <a class="nav-link text-muted px-1" href="#" title="Notifications" role="button" data-toggle="modal" data-target="#notificationModal">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img src="./{{asset('assets/media/heroicons/outline/bell.svg')}}" alt="" class="injectable hw-20"> -->
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item list-inline-item mr-0">
                                            <div class="dropdown">
                                                <a class="nav-link text-muted px-1" href="#" role="button" title="Details" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img src="./{{asset('assets/media/heroicons/outline/dots-vertical.svg')}}" alt="" class="injectable hw-20"> -->
                                                </a>
                            ...
                            <ul class="contacts-list" id="callLogTab" data-call-list="">
                                    ...
                                    <div class="contacts-link">
                                        ...
                                        <div class="contacts-content">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-16 text-muted mr-1" src="./{{asset('assets/media/heroicons/solid/phone-incoming.svg')}}" alt=""> -->
                                        ...
                                        <div class="contacts-action">
                                            <button class="btn btn-secondary btn-icon btn-minimal btn-sm text-muted" type="button">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-20" src="./{{asset('assets/media/heroicons/outline/phone.svg')}}" alt=""> -->
                                            </button>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="contacts-link outgoing">
                                        ...
                                        <div class="contacts-content">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-16 text-muted mr-1" src="./{{asset('assets/media/heroicons/solid/phone-outgoing.svg')}}" alt=""> -->
                                ...
                                <li class="contacts-item missed">
                                    ...
                                    <div class="contacts-link missed">
                                        <div class="avatar">
                                            <img src="{{asset('assets/media/avatar/3.png')}}" alt="">
                                        </div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-16 text-danger mr-1" src="./{{asset('assets/media/heroicons/solid/phone-incoming.svg')}}" alt=""> -->
                                ...
                                <li class="contacts-item incoming">
                                    ...
                                    <div class="contacts-link incoming">
                                        <div class="avatar">
                                            <img src="{{asset('assets/media/avatar/6.png')}}" alt="">
                                        </div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                ...
                                <li class="contacts-item outgoing">
                                    ...
                                    <div class="contacts-link outgoing">
                                        <div class="avatar">
                                            <img src="{{asset('assets/media/avatar/7.png')}}" alt="">
                                        </div>
                                        <div class="contacts-content">
                                            <div class="contacts-info">
                                    ...
                                    <a class="contacts-link" href="#">
                                        ...
                                        <div class="contacts-content">
                                            ...
                                            <div class="contacts-texts">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-16 text-muted mr-1" src="./{{asset('assets/media/heroicons/solid/location-marker.svg')}}" alt=""> -->
                                        ...
                                        <div class="card card-body card-bg-5">
                                            ...
                                            <div class="d-flex flex-column align-items-center">
                                                <div class="avatar avatar-lg mb-3">
                                                    <img class="avatar-img" src="{{asset('assets/media/avatar/3.png')}}" alt="">
                                                </div>
                                                ...
                                                <div class="d-flex">
                                                    <button class="btn btn-outline-default mx-1" type="button">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable hw-18 d-sm-inline-block" src="./{{asset('assets/media/heroicons/outline/logout.svg')}}" alt=""> -->
                                                        <span>Logout</span> 
                                                    </button>
                                                    <button class="btn btn-outline-default mx-1 d-xl-none" data-profile-edit="" type="button">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable hw-18 d-sm-inline-block" src="./{{asset('assets/media/heroicons/outline/cog.svg')}}" alt=""> -->
                                                        <span>Settings</span> 
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./{{asset('assets/media/heroicons/outline/clock.svg')}}" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./{{asset('assets/media/heroicons/outline/calendar.svg')}}" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./{{asset('assets/media/heroicons/outline/phone.svg')}}" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./{{asset('assets/media/heroicons/outline/mail.svg')}}" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./{{asset('assets/media/heroicons/outline/globe.svg')}}" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item pt-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./{{asset('assets/media/heroicons/outline/home.svg')}}" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./{{asset('assets/media/icons/facebook.svg')}}" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./{{asset('assets/media/icons/twitter.svg')}}" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./{{asset('assets/media/icons/instagram.svg')}}" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./{{asset('assets/media/icons/linkedin.svg')}}" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                ...
                <div class="chat-body">
                    ...
                    <div class="chat-header">
                        ...
                        <button class="btn btn-secondary btn-icon btn-minimal btn-sm text-muted d-xl-none" type="button" data-close="">
                            ...
                            <!-- Alternate :: External File link -->
                            <!-- <img class="injectable hw-20" src="./{{asset('assets/media/heroicons/outline/arrow-left.svg')}}" alt=""> -->
                        </button>
                        ...
                        <ul class="nav flex-nowrap">
                            <li class="nav-item list-inline-item d-none d-sm-block mr-1">
                                <a class="nav-link text-muted px-1" data-toggle="collapse" data-target="#searchCollapse" href="#" aria-expanded="false">
                                    ...
                                    <!-- Alternate :: External File link -->
                                    <!-- <img src="./{{asset('assets/media/heroicons/outline/search.svg')}}" alt="" class="injectable hw-20"> -->
                                </a>
                            </li>
                            ...
                            <li class="nav-item list-inline-item d-none d-sm-block mr-1">
                                <a class="nav-link text-muted px-1" href="#" title="Add People">
                                    ...
                                    <!-- Alternate :: External File link -->
                                    <!-- <img src="./{{asset('assets/media/heroicons/outline/phone.svg')}}" alt="" class="injectable hw-20"> -->
                                </a>
                            </li>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item align-items-center d-flex" href="#" data-chat-info-toggle="">
                                            ...
                                            <!-- Alternate :: External File link -->
                                            <!-- <img src="./{{asset('assets/media/heroicons/outline/information-circle.svg')}}" alt="" class="injectable hw-20 mr-2"> -->
                                            <span>View Info</span>
                                        </a>
                                        ...
                                        <a class="dropdown-item align-items-center d-flex" href="#">
                                            ...
                                            <!-- Alternate :: External File link -->
                                            <!-- <img src="./{{asset('assets/media/heroicons/outline/volume-off.svg')}}" alt="" class="injectable hw-20 mr-2"> -->
                                        ...
                                        <a class="dropdown-item align-items-center d-flex" href="#">
                                            ...
                                            <!-- Alternate :: External File link -->
                                            <!-- <img src="./{{asset('assets/media/heroicons/outline/photograph.svg')}}" alt="" class="injectable hw-20 mr-2"> -->
                                            <span>Wallpaper</span>
                                        </a>
                                        <a class="dropdown-item align-items-center d-flex" href="#">
                                            <!-- Default :: Inline SVG -->
                                            ...
                                            <!-- Alternate :: External File link -->
                                            <!-- <img src="./{{asset('assets/media/heroicons/outline/archive.svg')}}" alt="" class="injectable hw-20 mr-2"> -->
                                            <span>Archive</span>
                                        </a>
                                        <a class="dropdown-item align-items-center d-flex" href="#">
                                            <!-- Default :: Inline SVG -->
                                            ...
                                            <!-- Alternate :: External File link -->
                                            <!-- <img src="./{{asset('assets/media/heroicons/outline/trash.svg')}}" alt="" class="injectable hw-20 mr-2"> -->
                                            <span>Delete</span>
                                        </a>
                                        <a class="dropdown-item align-items-center d-flex text-danger" href="#">
                                            ...
                                            <!-- Alternate :: External File link -->
                                            <!-- <img src="./{{asset('assets/media/heroicons/outline/ban.svg')}}" alt="" class="injectable hw-20 mr-2"> -->
                                            <span>Block</span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item align-items-center d-flex" href="#">
                                            ...
                                            <!-- Alternate :: External File link -->
                                            <!-- <img src="./{{asset('assets/media/heroicons/outline/phone.svg')}}" alt="" class="injectable hw-20 mr-2"> -->
                                            <span>Call</span>    
                                        </a>
                                        <a class="dropdown-item align-items-center d-flex" href="#" data-toggle="collapse" data-target="#searchCollapse" aria-expanded="false">
                                            ...
                                            <!-- Alternate :: External File link -->
                                            <!-- <img src="./{{asset('assets/media/heroicons/outline/search.svg')}}" alt="" class="injectable hw-20 mr-2"> -->
                                            <span>Search</span>    
                                        </a>
                            ...
                            <div class="input-group bg-light ">
                                ...
                                <div class="input-group-append">
                                    <span class="input-group-text transparent-bg border-left-0">
                                        ...
                                        <!-- Alternate :: External File link -->
                                        <!-- <img class="injectable hw-20" src="./{{asset('assets/media/heroicons/outline/search.svg')}}" alt="Search icon"> -->
                                    </span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="message-day">
                                ...
                                <div class="message">
                                    ...
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="{{asset('assets/media/avatar/6.png')}}"></div>
                                        ...
                                        <div class="dropdown">
                                            <a class="text-muted" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-18" src="./{{asset('assets/media/heroicons/outline/dots-horizontal.svg')}}" alt="message options"> -->
                                            </a>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./{{asset('assets/media/heroicons/outline/duplicate.svg')}}" alt="message options"> -->
                                                    <span>Copy</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./{{asset('assets/media/heroicons/outline/reply.svg')}}" alt="message replay"> -->
                                                    <span>Replay</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable rotate-y hw-18 mr-2" src="./{{asset('assets/media/heroicons/outline/reply.svg')}}" alt="message forward"> -->
                                                    <span>Forward</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./{{asset('assets/media/heroicons/outline/star.svg')}}" alt="message favourite"> -->
                                                    <span>Favourite</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center text-danger" href="#">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./{{asset('assets/media/heroicons/outline/trash.svg')}}" alt="message delete"> -->
                                                    <span>Delete</span>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./{{asset('assets/media/heroicons/outline/pencil.svg')}}" alt="message edit"> -->
                                                    <span>Edit</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                        ...
                                        <div class="message-content">
                                            <div class="document">
                                                <div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/outline/document.svg')}}" alt=""> -->
                                                </div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    ...
                                                    <!-- Alternate :: External File link -->
                                                    <!-- <img class="injectable hw-18 mr-2" src="./{{asset('assets/media/heroicons/outline/download.svg')}}" alt="download"> -->
                                                    <span>Download</span>
                                                </a>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <!-- Default :: Inline SVG -->
                                ...
                                <div class="message">
                                    <div class="message-wrapper">
                                        <div class="message-content">
                                            ...
                                            <div class="form-row">
                                                <div class="col">
                                                    <a class="popup-media" href="{{asset('assets/media/shared-photos/01.jpg')}}">
                                                        <img class="img-fluid rounded" src="{{asset('assets/media/shared-photos/01.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <a class="popup-media" href="{{asset('assets/media/shared-photos/02.jpg')}}">
                                                        <img class="img-fluid rounded" src="{{asset('assets/media/shared-photos/02.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                                <div class="col">
                                                    <a class="popup-media" href="{{asset('assets/media/shared-photos/03.jpg')}}">
                                                        <img class="img-fluid rounded" src="{{asset('assets/media/shared-photos/03.jpg')}}" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="chat-footer">
                        <div class="attachment">
                            <div class="dropdown">
                                <button class="btn btn-secondary btn-icon btn-minimal btn-sm" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <!-- <img class="injectable hw-20" src="./{{asset('assets/media/heroicons/outline/plus-circle.svg')}}" alt=""> -->
                                </button>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="#">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./{{asset('assets/media/heroicons/outline/photograph.svg')}}" alt=""> -->
                                        <span>Gallery</span>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./{{asset('assets/media/heroicons/outline/volume-up.svg')}}" alt=""> -->
                                        <span>Audio</span>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./{{asset('assets/media/heroicons/outline/document.svg')}}" alt=""> -->
                                        <span>Document</span>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./{{asset('assets/media/heroicons/outline/user.svg')}}" alt=""> -->
                                        <span>Contact</span>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./{{asset('assets/media/heroicons/outline/location-marker.svg')}}" alt=""> -->
                                        <span>Location</span>
                                    </a>
                                    <a class="dropdown-item" href="#">
                                        <svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <!-- <img class="injectable hw-20 mr-2" src="./{{asset('assets/media/heroicons/outline/chart-square-bar.svg')}}" alt=""> -->
                                        <span>Poll</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="btn btn-primary btn-icon send-icon rounded-circle text-light mb-1" role="button">
                            ...
                            <!-- <img src="./{{asset('assets/media/heroicons/outline/arrow-right.svg')}}" alt="" class="injectable"> -->
                        </div>
                    </div>
                    <!-- Chat Footer End-->
                </div>
                                ...
                                <ul class="nav justify-content-between align-items-center">
                                    ...
                                    <li class="nav-item list-inline-item">
                                        <a class="nav-link text-muted px-0" href="#" data-chat-info-close="">
                                            ...
                                            <!-- Alternate :: External File link -->
                                            <!-- <img class="injectable hw-22" src="./{{asset('assets/media/heroicons/outline/x.svg')}}" alt=""> -->
                        ...
                        <div class="hide-scrollbar flex-fill">
                            ...
                            <div class="text-center p-3">
                                ...
                                <div class="avatar avatar-xl mx-5 mb-3">
                                    <img class="avatar-img" src="{{asset('assets/media/avatar/2.png')}}" alt="">
                                </div>
                                ...
                                <p class="text-muted d-flex align-items-center justify-content-center">
                                    ...
                                    <!-- Alternate :: External File link -->
                                    <!-- <img class="injectable mr-1 hw-18" src="./{{asset('assets/media/heroicons/outline/location-marker.svg')}}" alt=""> -->
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    <div class="btn btn-outline-default btn-icon rounded-circle mx-1">
                                        ...
                                        <!-- Alternate :: External File link -->
                                        <!-- <img class="injectable hw-20" src="./{{asset('assets/media/heroicons/outline/user-add.svg')}}" alt=""> -->
                                    </div>
                                    <div class="btn btn-primary btn-icon rounded-circle text-light mx-1">
                                        ...
                                        <!-- Alternate :: External File link -->
                                        <!-- <img class="injectable hw-20" src="./{{asset('assets/media/heroicons/outline/heart.svg')}}" alt=""> -->
                                    </div>
                                    <div class="btn btn-danger btn-icon rounded-circle text-light mx-1">
                                        ...
                                        <!-- Alternate :: External File link -->
                                        <!-- <img class="injectable hw-20" src="./{{asset('assets/media/heroicons/outline/ban.svg')}}" alt=""> -->
                                    </div>
                                </div>
                            </div>
                            <!-- User Profile End -->
                            ...
                            <div class="chat-info-group">
                                <a class="chat-info-group-header" data-toggle="collapse" href="#profile-info" role="button" aria-expanded="true" aria-controls="profile-info">
                                    ...
                                    <!-- Alternate :: External File link -->
                                    <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/heroicons/outline/information-circle.svg')}}" alt=""> -->
                                  </a>
                            ...
                            <div class="chat-info-group">
                                <a class="chat-info-group-header" data-toggle="collapse" href="#shared-media" role="button" aria-expanded="true" aria-controls="shared-media">
                                    ...
                                    <!-- Alternate :: External File link -->
                                    <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/heroicons/outline/photograph.svg')}}" alt=""> -->
                                  </a>
                                    ...
                                    <div class="chat-info-group-content">
                                        ...
                                        <div class="form-row">
                                            <div class="col-4 col-md-2 col-xl-4">
                                                <a href="#">
                                                    <img src="{{asset('assets/media/shared-photos/01.jpg')}}" class="img-fluid rounded border" alt="">
                                                </a>
                                            </div>
                                            <div class="col-4 col-md-2 col-xl-4">
                                                <a href="#">
                                                    <img src="{{asset('assets/media/shared-photos/02.jpg')}}" class="img-fluid rounded border" alt="">
                                                </a>
                                            </div>
                                            <div class="col-4 col-md-2 col-xl-4">
                                                <a href="#">
                                                    <img src="{{asset('assets/media/shared-photos/03.jpg')}}" class="img-fluid rounded border" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="chat-info-group">
                                <a class="chat-info-group-header" data-toggle="collapse" href="#shared-files" role="button" aria-expanded="true" aria-controls="shared-files">
                                    ...
                                    <!-- Alternate :: External File link -->
                                    <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/heroicons/outline/document.svg')}}" alt=""> -->
                                </a>
                                            ...
                                            <li class="list-group-item">
                                                <div class="document">
                                                    <div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable hw-24" src="./{{asset('assets/media/icons/excel-file.svg')}}" alt=""> -->
                                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="document">
                                                    <div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable hw-24" src="./{{asset('assets/media/icons/powerpoint-file.svg')}}" alt=""> -->
                                                    </div>
                                    ...
                                    <div class="media">
                                        <div class="avatar avatar-primary mr-2">
                                            <span>
                                                ...
                                                <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/solid/phone-incoming.svg')}}" alt=""> -->
                                            </span>
                                        </div>
                                    ...
                                    <div class="media">
                                        <div class="avatar avatar-primary mr-2">
                                            <span>
                                                ...
                                                <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/solid/phone-outgoing.svg')}}" alt=""> -->
                                            </span>
                                        </div>
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <div class="d-flex mt-2">
                                            <div class="btn btn-primary btn-icon rounded-circle text-light mx-2">
                                                ...
                                                <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/outline/chat.svg')}}" alt=""> -->
                                            </div>
                                            <div class="btn btn-success btn-icon rounded-circle text-light mx-2">
                                                ...
                                                <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/outline/phone.svg')}}" alt=""> -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/heroicons/outline/clock.svg')}}" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/heroicons/outline/calendar.svg')}}" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/heroicons/outline/phone.svg')}}" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/heroicons/outline/mail.svg')}}" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/heroicons/outline/globe.svg')}}" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/heroicons/outline/home.svg')}}" alt=""> -->
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/icons/facebook.svg')}}" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/icons/twitter.svg')}}" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/icons/instagram.svg')}}" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./{{asset('assets/media/icons/linkedin.svg')}}" alt=""> -->
                                        </div>
                                    </li>
                                </ul>
                            </div>
                ...
                <ul class="nav nav-minimal appbar-nav" id="appNavTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="translator-tab" data-toggle="tab" href="#translator" role="tab" aria-controls="translator" aria-selected="true">
                            <!-- <img class="injectable hw-22" src="./{{asset('assets/media/heroicons/outline/translate.svg')}}" alt=""> -->
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="notes-tab" data-toggle="tab" href="#notes" role="tab" aria-controls="notes" aria-selected="false">
                            <!-- <img class="injectable hw-22" src="./{{asset('assets/media/heroicons/outline/collection.svg')}}" alt=""> -->
                            <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="todo-tab" data-toggle="tab" href="#todo" role="tab" aria-controls="todo" aria-selected="false">
                            <!-- <img class="injectable hw-22" src="./{{asset('assets/media/heroicons/outline/clipboard-check.svg')}}" alt=""> -->
                            <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="quick-settings-tab" data-toggle="tab" href="#quick-settings" role="tab" aria-controls="quick-settings" aria-selected="false">
                            <!-- <img class="injectable hw-22" src="./{{asset('assets/media/heroicons/outline/cog.svg')}}" alt=""> -->
                            <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                              </svg>                              
                        ...
                        <div class="d-flex flex-column justify-content-center text-center h-100 w-100">
                            <div class="container">
                                <div class="avatar avatar-lg mb-2">
                                    <img class="avatar-img" src="{{asset('assets/media/avatar/4.png')}}" alt="">
                                </div>
                        ...
                        <div class="appnavbar-scrollable-wrapper">
                            ...
                            <div class="appnavbar-body">
                                <div class="appnavbar-body-title">
                                    ...
                                    <img class="injetable hw-16 text-muted mx-1" src="https://themes.openux.studio/quicky/assets/media/heroicons/outline/arrow-right.svg')}}" alt="">
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        <div class="avatar avatar-online mr-2">
                                            <img src="{{asset('assets/media/avatar/1.png')}}" alt="">
                                        </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center flex-column h-100">
                                    <div class="btn btn-success btn-icon rounded-circle text-light mb-3">
                                        ...
                                        <!-- Alternate :: External File link -->
                                        <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/outline/check.svg')}}" alt=""> -->
                                    </div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            <div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/outline/user-add.svg')}}" alt=""> -->
                                            </div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            <div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/outline/check-circle.svg')}}" alt=""> -->
                                            </div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            <div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
                                                ...
                                                <!-- Alternate :: External File link -->
                                                <!-- <img class="injectable hw-24" src="./{{asset('assets/media/heroicons/outline/photograph.svg')}}" alt=""> -->
                                            </div>
